                    ...
                    <div class="col-xl-8">
                        <div class="service-details-wrapper">
                            ...
                            <div class="meta d-flex align-items-center">
                                ...
                                <p class="orders-counts">{{ $service->Orders()->count() }} Orders in Queue</p>
                            </div>
                            <div class="serv-details-slider-wrapper">
                                <div class="serv-details-slider-1 owl-carousel">
                                    <div class="item">
                                        <img src="{{ asset('assets/site/images/services/single-1.png') }}">
                                    </div>
                                    <div class="item">
                                ...
                                <div class="slider-2-wrapper">
                                    <div class="serv-details-slider-2 owl-carousel">
                                        <div class="item">
                                            <img src="{{ asset('assets/site/images/services/single-thumb-1.png') }}">
                                        </div>
                                        <div class="item">
                                            <img src="{{ asset('assets/site/images/services/si-1.png') }}">
                                        </div>
                            ...
                            <div class="about-serv-sec">
                                <h3 class="title">About This Service</h3>
                                <div class="content">
...
{{--                                    <p>Minimalist Modern Logo Design | Minimal | Modern | Typography | Line art | Custom logo | Vintage </p>--}}
                    ...
                    <div class="col-xl-4">
                        <aside class="service-sidebar">
                            <h3 class="title">Service Plans</h3>
                            <div class="plans-tabs">
                                <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="basic-tab" data-toggle="pill" href="#basic-plan" role="tab" >Basic</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="standard-tab" data-toggle="pill" href="#standard-plan" role="tab">Standard</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="premium-tab" data-toggle="pill" href="#premium-plan" role="tab">Premium</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="basic-plan" role="tabpanel">
                                        <div class="plan-details-wrapper">
                                            <div class="head d-flex align-items-center justify-content-between">
                                                <h4>Basic Pack</h4>
                                                <p class="price">55.23 SAR</p>
                                            </div>
                                            <div class="brief">
                                                <p>2 BASIC logo options in JPG & PNG transparent.</p>
                                                <p>No Vector. No mascot or illustration.</p>
                                            </div>
                                            ...
                                            <ul class="serv-features">
                                                <li class="active"><i class="fas fa-check"></i> 2 Initial Concepts Included</li>
                                                <li><i class="fas fa-check"></i> Source File</li>
                                                <li class="active"><i class="fas fa-check"></i> Logo Transparency</li>
                                                <li class="active"><i class="fas fa-check"></i> High Resolution</li>
                                            </ul>

                                            <button type="button" class="btn btn-block btn-yallow serv-continue-btn">Continue (55.23 SAR)</button>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="standard-plan" role="tabpanel">...</div>
                                    <div class="tab-pane fade" id="premium-plan" role="tabpanel">...</div>
                                </div>
                            ...
                            <div class="serv-question d-flex align-items-center">
                                ...
                                <button class="btn btn-yallow" data-toggle="modal" data-target="#sendMessageModal">Contact Seller</button>
                            </div>
                        </aside>
                    </div>
                </div>
