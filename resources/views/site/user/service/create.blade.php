                                            ...
                                            <div class="add-service-content">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <textarea id="service-title" name="title" class="form-control input_to_count title" placeholder="@lang('site.service_title_hint')"
                                                                          rows="2">{{ ($service && $service->title) ? $service->title : null }}</textarea>
                                                                ...
                                                                <div class="cat-item mr-3">
                                                                    <select id="cat-1" class="form-control nice-select-me main_category_type" name="main_category_type">
                                                                        ...
                                                                        @foreach(\Helper::getMainCategoriesType(false,app()->getLocale()) as $key => $value)
                                                                            <option
                                                                                {{ ($service && $service->main_category_type && $service->main_category_type == $key ) ? 'selected' : '' }} value="{{$key}}">{{ $value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="cat-item">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div class="checkbox-contain mr-1">
                                                                                                <div class="custom-control custom-checkbox">
                                                                                                    <input type="checkbox" checked class="custom-control-input language" id="customCheck1" value="ar"
                                                                                                           name="language">
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="checkbox-contain ml-1">
                                                                                                <div class="custom-control custom-checkbox">
                                                                                                    <input type="checkbox" checked class="custom-control-input language" id="customCheck2" value="en"
                                                                                                           name="language">
                                                ...
                                                <fieldset class="wizard-fieldset">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <input type="text" id="basic-pricing-title" value="{{ ($service && $service->basic_title) ? $service->basic_title : null }}"
                                                                       name="basic_title" class="form-control input_to_count title wizard-required" placeholder="@lang('site.pricing_title')"/>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <input type="number" min="1" value="{{ ($service && $service->basic_delivery_days) ? $service->basic_delivery_days : '1' }}" step="1"
                                                                       id="basic-pricing-delivery_days" name="basic_delivery_days" class="form-control input_to_count title wizard-required"
                                                                       placeholder="@lang('site.pricing_delivery_days')"/>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <textarea id="basic-pricing-description" name="basic_description" class="form-control input_to_count title wizard-required"
                                                                          placeholder="@lang('site.pricing_description')"
                                                                          rows="2">{!!  ($service && $service->basic_description) ? $service->basic_description : ''  !!}</textarea>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <input type="text" id="standard-pricing-title" value="{{ ($service && $service->standard_title) ? $service->standard_title : null }}"
                                                                       name="standard_title" class="form-control input_to_count title wizard-required" placeholder="@lang('site.pricing_title')"/>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <input type="number" min="1" value="{{ ($service && $service->standard_delivery_days) ? $service->standard_delivery_days : '1' }}" step="1" id="standard-pricing-delivery_days" name="standard_delivery_days"
                                                                       class="form-control input_to_count title wizard-required" placeholder="@lang('site.pricing_delivery_days')"/>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <textarea id="standard-pricing-description" name="standard_description" class="form-control input_to_count title wizard-required"
                                                                          placeholder="@lang('site.pricing_description')" rows="2">{!!  ($service && $service->standard_description) ? $service->standard_description : ''  !!}</textarea>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <input type="text" id="premium-pricing-title" value="{{ ($service && $service->premium_title) ? $service->premium_title : null }}"
                                                                       name="premium_title" class="form-control input_to_count title wizard-required" placeholder="@lang('site.pricing_title')"/>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <input type="number" min="1" value="{{ ($service && $service->premium_delivery_days) ? $service->premium_delivery_days : '1' }}" step="1" id="premium-pricing-delivery_days" name="premium_delivery_days"
                                                                       class="form-control input_to_count title wizard-required" placeholder="@lang('site.pricing_delivery_days')"/>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <textarea id="premium-pricing-description" name="premium_description" class="form-control input_to_count title wizard-required"
                                                                          placeholder="@lang('site.pricing_description')" rows="2">{!!  ($service && $service->premium_description) ? $service->premium_description : ''  !!}</textarea>
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="add-service-content">
                                                        ...
                                                        <div class="add-service-desc-sec">
                                                            <div class="form-group">
                                                                ...
                                                                {{--                                            <div id="editor"></div>--}}
                                                                <textarea name="description" class="form-control input_to_count_2" cols="30" rows="10">{!!  ($service && $service->description) ? $service->description : ''  !!}</textarea>
