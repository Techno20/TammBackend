...
@section('css')
    ...
    <style>
        #requirements{position:absolute; top:-100px; display: none}
    </style>
@endsection
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <div class="total-meta d-flex align-item-center">
                                                                    ...
                                                                    <p class="total-reviews">1k+ @lang('site.total_reviews')</p>
                                                                </div>
                                ...
                                <div class="add-service-content">
                                    ...
                                    <div class="send-message-comp">
                                        <div class="message-wrapper d-flex flex-column ">
                                            <textarea name="" class="form-control input_to_count" placeholder="اكتب رسالتك هنا"></textarea>
...
{{--                                <form id="form-container" method="post" action="/charge">--}}
                                    ...
                                    <!-- Tap pay button -->
                                    <button id="tap-btn">تأكيد الدفع</button>
{{--                                </form>--}}
