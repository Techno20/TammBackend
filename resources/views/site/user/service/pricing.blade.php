                ...
                <div class="container">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="page-action-btns">
                            <a class="btn btn-tamm add_service_pricing_button">@lang('site.save')</a>
                ...
                <div class="container">
                    <div class="paginator-holder">
                        <ul class="list-unstyled mb-0 nav justify-content-center">
                            ...
                            <li><a href="" class="nav-link active"><span>2</span> @lang('site.pricing')</a></li>
                    ...
                    <div class="col-xl-9">
                        <div class="add-service-content">
                            ...
                            <div class="add-service-pricing-sec">
                                ...
                                <select name="" multiple="multiple" class="form-control select2" id=""></select>
